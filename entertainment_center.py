...
fear_loathing_las_vegas = media.Movie("Fear and loathing in Las Vegas",
	"https://youtu.be/Zm7r491n-8o")
fight_club = media.Movie("Fight Club",
	"https://youtu.be/D3Yw9Yc1YmY")
babel = media.Movie("Babel",
	"https://youtu.be/gzrHrTVaqJs")
american_beauty = media.Movie("American Beauty",
	"https://youtu.be/3ycmmJ6rxA8")
lemony_snicket = media.Movie("A series of Unfortunate Events",
	"https://youtu.be/fccho1IyX8Y")


movies = [v_for_vendetta, almost_famous, closer, dogville, snatch, paris_texas, taxi_driver, fear_loathing_las_vegas, fight_club, babel, american_beauty, lemony_snicket]
